      ...
      <div className="xsm:pt-5 md:pt-0   flex flex-col gap-[2vh]  md:justify-between ">
        <div className="  xsm:!w-[90vw] lg:w-[80vw] m-auto flex ">
          <div className="flex flex-col   xsm:!w-[92vw] sm:w-[90vw] lg:!w-[80vw] m-auto !rounded-xl">
            ...
            <div className="xsm:grid xsm:grid-cols-2 xsm:gap-10 md:grid-cols-3  xsm:m-auto lg:m-0 lg:gap-y-4 w-[100%]  xxl:gap-x-5 lg:gap-0 xl:flex">
              {bestProducts.slice(0, 6).map((data) => {
                return (
                  <div
                    className="relative flex flex-col  items-center justify-center xsm:w-[40vw]  md:w-[22vw]      bg-[#fff] shadow-md"
                    key={data._id}
                    onClick={() =>
                      router.push({
                  ...
                  >
                    ...
                    <p className="text-center xsm:text-[8px] lg:pt-[15px] md:!text-[13px] md:pt-0  xsm:pt-[10px]   lg:text-[8px] lg:leading-tight lg:tracking-tight xl:!text-[11px] px-[10px] xxl:!text-[14px] xxl:pt-0 font-semibold ">
                      {data.title}
                    </p>
        ...
        <div className="  xsm:w-[90vw] lg:w-[80vw] m-auto " id={styles.shadow2}>
          <div>
            <div className="flex xsm:w-[90vw] lg:w-[80vw] md:text-md xsm:text-[14px]  xl:text-xl  justify-between m-auto px-5 bg-[var(--second-color)] py-3 text-white">
              ...
              <Link href="flashDeals">
                <h1 className="xsm:text-[14px] xl:text-xl md:text-md">
                  See All &#8594;
                </h1>
              </Link>
            </div>
